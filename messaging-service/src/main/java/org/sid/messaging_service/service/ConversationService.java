...
public class ConversationService {
    ...
    public List<Conversation> findVisibleFor(MessagingUser user, Instant from, Instant to) {
        return findVisibleFor(user).stream()
                .filter(conversation -> isWithinRange(conversation.getCreatedAt(), from, to))
                .toList();
    }
